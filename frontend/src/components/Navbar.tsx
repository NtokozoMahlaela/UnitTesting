...
import { Menu, X, Shield, BarChart3, Home, Info } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: 'Validate ID', href: '/validate', icon: Shield },
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-800">SA ID Validator</span>
          </Link>
